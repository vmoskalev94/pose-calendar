...
import {DetailsPanel} from "./components/calendar/DetailsPanel";
...
type PackFormState = PackFormValues;
type ReleaseFormState = ReleaseFormValues;
...
export function LegacyAppContent() {
                        ...
                        panel={
                          ...
                          <span style={badgeStyle(getPackTypeBadgeColors(pack.type))}>
                            {packTypeLabel(pack.type)}
                                                            ...
                                                            <span
                                                                style={badgeStyle(getPackStatusBadgeColors(pack.status))}>
                            ...
                            >
                              ...
                              <span style={badgeStyle(getPackTypeBadgeColors(event.packType))}>
                                {packTypeLabel(event.packType)}
                                                                    ...
                                                                    <span
                                                                        style={badgeStyle(getPackStatusBadgeColors(event.packStatus))}>
                                {packStatusLabel(event.packStatus)}
                                        ...
                                        {isReleaseFormOpen && (
                                            ...
                                            >
                                                ...
                                                {/* чекбоксы площадок оставляем как есть */}
                                                <div
                                                    style={{
                                                        display: "flex",
                                                        flexWrap: "wrap",
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <input
                                                            ...
                                                            onChange={() =>
                                                                toggleReleaseFlag("telegramPlanned")
                                                            }
                                                        />
                                                        Telegram
                                                    </label>
                                                    ...
                                                    >
                                                        <input
                                                            ...
                                                            onChange={() =>
                                                                toggleReleaseFlag("boostyPlanned")
                                                            }
                                                        />
                                                        Boosty
                                                    </label>
                                                    ...
                                                    >
                                                        <input
                                                            ...
                                                            onChange={() =>
                                                                toggleReleaseFlag("tumblrPlanned")
                                                            }
                                                        />
                                                        Tumblr
                                                    </label>
